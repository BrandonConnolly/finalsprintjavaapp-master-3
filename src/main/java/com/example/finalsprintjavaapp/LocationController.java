...
public class LocationController {
    ...
    private void LoadLocationsData() {
        try {
            File airportsFile = new File("src/main/java/com/example/finalsprintjavaapp/airports.txt");
            File citiesFile = new File("src/main/java/com/example/finalsprintjavaapp/cities.txt");
            File aircraftFile = new File("src/main/java/com/example/finalsprintjavaapp/aircraft.txt");
